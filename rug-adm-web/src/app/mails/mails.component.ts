...
export class MailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.httpSubscription = this.externalUsersService.fetchData("ALLCE", this.currentPage, this.pageSize, this.filtro).subscribe(
      res => {
        this.users = res.data;
  ...
  onViewMailsClicked(user: ExternalUser) {
    ...
    this.loading = true;
    this.loadingService.changeLoading(this.loading);
    this.httpSubscription = this.mailsService.fetchData(user.personaId, null).subscribe(
      res => {
        this.mails = res;
  ...
  onPageChange(page: number) {
    ...
    this.loading = true;
    this.loadingService.changeLoading(this.loading);
    this.httpSubscription = this.externalUsersService.fetchData("ALLCE", page, this.pageSize, this.filtro).subscribe(
      res => {
        this.users = res.data;
        this.total = res.total;
  ...
  refreshData() {
    ...
    this.loading = true;
    this.loadingService.changeLoading(this.loading);
    this.httpSubscription = this.externalUsersService.fetchData("ALLCE", 1, this.pageSize, this.filtro).subscribe(
      res => {
        this.users = res.data;
        this.total = res.total;
        this.currentPage = 1;
