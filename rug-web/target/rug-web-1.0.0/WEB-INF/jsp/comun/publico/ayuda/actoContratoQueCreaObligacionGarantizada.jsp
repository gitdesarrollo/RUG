...
<table cellspacing="0" cellpadding="0" width="90%" height="90%"
	...
	<tr>
		<td class="tituloInteriorRojo">
			<br class="tituloInteriorRojo"><s:text name="Acto o Contrato que crea la Obligación Garantizada." /><br />
	...
	<tr>
		<td align="justify">		
			<br class="texto_general">
				<s:text	name="Ingrese la información de la obligación principal que se garantiza mediante la Garantía Mobiliaria." /> 
			<br><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td align="justify">		
			<br class="texto_general">
				<s:text	name="Contrato de crédito simple número 00012352221545, de fecha 5 de septiembre de 2010." /> 
		</td>
	</tr>
</table>
