...
<a href="Inscripcion_02.htm">Inscripcion_02</a><TABLE class="workArea" cellspacing="0" cellpadding="0">
<TBODY><TR>
	<TD class="sideMenu">
		      ...
		      <td><table align="right" cellspacing="5" class="menuLateral">
		        <tbody>
		          <tr class="menuLateralNivel1">
		            <td align="left">&nbsp;</td>
		            <td align="left" class="tituloInteriorRojo">Inscripci&oacute;n</td>
		            </tr>
		          <tr class="menuLateralNivel1">
		            ...
		            <td width="122" align="left"><a href="Inscripcion_01.htm" class="textoGeneralGrisBold" id="menua">1. Datos Generales</a></td>
		            </tr>
		          <tr>
		            <td class="texto_general"><img src="<%= request.getContextPath() %>/imgs/cuadroVerde.png" alt="" width="11" height="11" /></td>
		            <td class="texto_general"><a href="Inscripcion_02.htm" class="textoGeneralGrisBold" id="menua2">2. Datos de la Garant&iacute;a Mobiliaria</a></td>
		            </tr>
		          <tr>
		            <td class="texto_general"><img src="<%= request.getContextPath() %>/imgs/cuadroVerde.png" alt="" width="11" height="11" /></td>
		            <td class="texto_general"><a href="Validaci&oacute;n.htm" class="textoGeneralGrisBold" id="menua3">3. Validaci&oacute;n</a></td>
		            </tr>
		          <tr>
		            <td class="texto_general"><img src="<%= request.getContextPath() %>/imgs/cuadroVerde.png" alt="" width="11" height="11" /></td>
		            <td class="texto_general"><a href="Pago de Derechos.htm" class="textoGeneralGrisBold" id="menua4">4. Pago de derechos</a></td>
		            </tr>
		          </tbody>
		        </table></td>
		      </tr>
        		...
        		<TBODY><TR>
        			<TD class="titulo_interior_naranja">
	            		<TABLE width="289">
	                    	<TBODY>
	                    	  <TR>
	                    		<TD width="261" height="32" class="titulo_exterior_rojo">
	                    			Cancelaci&oacute;n de Registro</TD>
	                    		<TD width="16" align="left">
				                   	<A tabindex="31" href="http://www.tuempresa.gob.mx/portal/comun/publico/help.do?llave=domicilio&keepThis=true&TB_iframe=true&height=500&width=500" title="Ayuda en el domicilio" class="thickbox">
					                   	<IMG alt="Ayuda en el domicilio" src="./img/documentinfo.png" border="0">				                   	</A>	                    		</TD>
	                    	</TR>
	            		</TBODY></TABLE>
            		</TD>
          		</TR>  
         		    ...
         		    <tbody>
         		      <tr>
         		        <td colspan="5"><table>
         		          <tbody>
         		            <tr>
         		              <td class="tituloInteriorRojo">Garante(s)&nbsp; </td>
         		              <td align="left" valign="bottom"><a tabindex="32" href="http://www.tuempresa.gob.mx/portal/comun/publico/help.do?llave=domiciliosRegistrados&amp;keepThis=true&amp;TB_iframe=true&amp;height=500&amp;width=500" title="Ayuda en los domicilios registrados" class="thickbox"> <img alt="Ayuda en los domicilios registrados" src="./img/documentinfo.png" border="0" /></a></td>
       		              </tr>
       		            </tbody>
       		          </table></td>
         		                          ...
         		                          <tbody>
         		                            ...
         		                            <tr>
         		                              ...
         		                              <td><input tabindex="41" type="text" autocomplete="off" id="cp" name="domicilio.cp" size="6" class="campo_general" maxlength="5" onchange="javascript:_buscarDomicilio(this);" onkeyup="javascript:_buscarDomicilio(this);" onkeypress="return IsNumber(event);" onfocus="onFocusSwitch(this,2); estilo_foco(this,'codpos','error_cp', 'erroredo', 'HelpComodin'); " onblur="onBlurSwitch(this,2); estilo_sinfoco(this,'codpos','error_cp', '-1' , 'errorcod');  " value="" />
         		                                <img src="Otras/Secretar&iacute;a de Econom&iacute;a - Portal de Empresas_files/pixel_gris.gif" alt="" width="1" height="1" border="0" align="bottom" id="cpImage" /></td>
         		                              <td class="texto_general" valign="top"><span id="codpos" style="position:absolute;color:ff3300;display:none;width:200;">
         		                                <table cellspacing="0" cellpadding="2" width="200">
         		                                  ...
         		                                  <table cellspacing="0" cellpadding="2" width="200">
         		                                    <tbody>
         		                                      <tr valign="top">
         		                                        <td align="left"><img src="<%= request.getContextPath() %>/Secretar&iacute;a de Econom&iacute;a - Portal de Empresas_files/helper_arrow_error.png" alt="" /></td>
         		                                        <td class="ComunicaError">Campo obligatorio.</td>
         		                                        </tr>
         		                                      </tbody>
         		                                    </table>
...
<TABLE cellspacing="0" cellpadding="0" width="100%">
	<TBODY><TR align="center">
		<TD class="btnSubmit">		
			<A href="http://www.tuempresa.gob.mx/portal/empresa/domicilios/show.do"><IMG src="./img/botonCancelar.png" name="Cancelar" border="0"></A>
			
			<A href="javascript:guardar('idDomicilio');">
				<IMG src="./img/botonGuardar.png">
			</A>
