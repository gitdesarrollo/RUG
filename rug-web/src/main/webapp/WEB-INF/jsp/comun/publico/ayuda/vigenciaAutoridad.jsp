...
<table cellspacing="0" cellpadding="0" width="90%" height="90%"
	...
	<tr>
		<td class="tituloInteriorRojo">
			<p class="tituloInteriorRojo"><s:text name="Autoridad que instruye la Renovación o Reducción de la Vigencia y Resolución Judicial o Administrativa en la cual se funda la anotación  " /><br />
	...
	<tr valign=top>
		<td  class="titulo_interior">			
			<p><a href="/Rug/resources/pdf/legislacion/LEY GENERAL DE TITULOS Y OPERACIONES DE CREDITO.pdf" class= ver_todas3 target=_blank> Ley General de Títulos y Operaciones de Crédito	</a></p>
		</td>	
	</tr>		
	<tr>
		<td align="justify">			
