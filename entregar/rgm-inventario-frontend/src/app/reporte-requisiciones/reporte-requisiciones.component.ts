...
@Component({
  selector: 'app-reporte-requisiciones',
  templateUrl: './reporte-requisiciones.component.html',
  styleUrls: ['./reporte-requisiciones.component.css']
})
export class ReporteRequisicionesComponent implements OnInit {
