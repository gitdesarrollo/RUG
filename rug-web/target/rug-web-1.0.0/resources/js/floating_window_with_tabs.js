	...
	************************************************************************************************************/	
	...
	var floating_window_skin;
	switch(floating_window_skin){
		case 2:
			document.getElementById('cssRef').href = '/portal/css/floating_window_with_tabs-skin2.css';
			var tabRightInActive = "/portal/imgs/skin2_tab_right_inactive.gif";
			var tabRightActive = "/portal/imgs/skin2_tab_right_active.gif";
			var tabImagePrefix = "/portal/imgs/skin2_tab_right_";
			var closeButtonMouseOverColor = '#006BF8';
			break;
		default:
			
			var tabRightInActive = "/portal/imgs/tab_right_inactive.gif";
			var tabRightActive = "/portal/imgs/tab_right_active.gif";
			var tabImagePrefix = "/portal/imgs/tab_right_";
	...
	*/	
	...
	function createStatusBar(inputObj,noResize)
	{
		...
		img.src = '/portal/imgs/floating_window_resize.gif';
	...
	function initFloatingWindowWithTabs(windowID,tabs,windowHeight,windowWidth,leftPos,topPos,noScrollbars,noResize,noStatusBar,noCloseButton,noMinimizeButton,noMove)
	{
		...
		for(var no=0;no<contentDivs[countWindows].length;no++){
			if(no==activeTabIndexCookie) 
				contentDivs[countWindows][no].style.display='block' ;
				
			
			 else contentDivs[countWindows][no].style.display='none';
