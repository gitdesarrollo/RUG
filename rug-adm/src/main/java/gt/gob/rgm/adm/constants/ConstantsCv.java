package gt.gob.rgm.adm.constants;

import java.util.HashMap;
import java.util.Map;

import gt.gob.rgm.adm.constants.dao.ConstantsDAO;

public class ConstantsCv {

    public static Map<String, String> constantValue ;

    public static String getParamValue(String cve_constante){
        if(constantValue==null){
            ConstantsCv.constantValue= new ConstantsDAO().getConstants();
        }
        String regresa = "Code error: consvalerror";
        try{
            regresa = new String (ConstantsCv.constantValue.get(cve_constante));
        }catch(Exception e){
    ...
    public static Integer getIdDataType(String tipoDatoString) throws InfraestructureException{
        ...
        try{
            ...
            //e.printStackTrace();
            throw new InfraestructureException("No se encontro el tipo de Dato a Procesar");
        }
    ...
    public static String getContextPath() throws InfraestructureException {
        if(contextPath==null){
            throw new InfraestructureException("No se cargo el contextPath");
        }
        return contextPath;
    }

    public static void setContextPath(String contextPath) {
        if(ConstantsCv.contextPath==null){
            ConstantsCv.contextPath = new String(contextPath);
        }
    }
