...
<table cellspacing="0" cellpadding="0" width="90%" height="90%"
	...
	<tr>
		<td class="tituloInteriorRojo">
			<br class="tituloInteriorRojo"><s:text name="Folio Electrónico del Otorgante" />
	...
	<tr>
		<td align="justify">		
			<br class="texto_general">
				<s:text	name="El Folio Electrónico es el expediente electrónico de un Otorgante en el que se contienen los asientos relativos a Garantías Mobiliarias y las anotaciones. Dicho folio electrónico reside en la base de datos nacional del RUG prevista expresamente en el Código de Comercio." /> 
			<br>
		</td>
	</tr>
	<tr>
		<td align="justify">
			<br>
				<s:text name="Si el Otorgante es una Persona Moral, ingrese el número de Folio que fue asignado al Otorgante por el Registro Público de Comercio (aplica también para extranjeros)." />
			<br>
		</td>
	</tr>		
	<tr>
		<td align="justify">	
			<br>
				<s:text name="Si el Otorgante es Persona Física, ingrese el número de Folio que fue asignado al Otorgante por el RUG (aplica también para extranjeros)." />
			<br>	
		</td>
	</tr>	
	...
	<tr>
		<td  class="texto_general">			
			<br><a
				...
				class="ver_todas3" target="_blank"> <b><s:text name="Código de Comercio" /></b>
				</a>
			<br>
		</td>	
	</tr>	
	...
	<tr>
		<td align="justify">	
			<br>
				<s:text name="<b>XX.-</b> Las garantías mobiliarias que hubiere otorgado, así como los actos jurídicos por los que constituya un privilegio especial o derecho de retención sobre bienes muebles a favor de terceros, en los términos de lo dispuesto por los artículos 32 bis 1 a 32 bis 9 del presente Capítulo. " />
			<br>	
		</td>
	</tr>
	...
	<tr>
		<td align="justify">			 
			<br class="texto_general"> 
				<s:text name="Toda consulta y solicitud de certificación de una Garantía Mobiliaria inscrita en el RUG deberá llevarse a cabo exclusivamente conforme al artículo 34 de este Reglamento." />
			<br>
		</td>	
	</tr>		
