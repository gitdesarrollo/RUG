...
<table cellspacing="0" cellpadding="0" width="90%" height="90%"
	...
	<tr>
		<td class="tituloInteriorRojo">
			<br class="tituloInteriorRojo"><s:text name="Persona que solicita o Autoridad que instruye la Renovación o Reducción de la Vigencia y Resolución Judicial o Administrativa en la cual se funda la anotación" />
	...
	<tr>
		<td class="tituloInteriorRojo">	
			<br ><s:text name="Fundamento Legal" />
			<img src="<%= request.getContextPath() %>/resources/imgs/plecagris_delgada.jpg"
				width="500" height="3" />
			<br>
		</td>	
