...
public class RequisicionServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		Long idRequisicion = null;
		if(req.getParameter("idRequisicion")!=null) idRequisicion = Long.valueOf(req.getParameter("idRequisicion"));
		...
		if(tipoReporte == 2) {
			pdf = requisicionService.getReporteRequisicionPdf(params);
		} else {
			pdf = requisicionService.getReporteGeneralPdf(params);
		}
