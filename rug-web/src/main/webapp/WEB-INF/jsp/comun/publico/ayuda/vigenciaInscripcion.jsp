...
<table cellspacing="0" cellpadding="0" width="90%" height="90%"
	...
	<tr>
		<td align="justify">		
			<br class="texto_general">
				<s:text	name="Salvo que la vigencia de la inscripción o anotación se establezca en la formaprecodificada, ésta tendrá una vigencia de un año, misma que será susceptible de ser renovada." /> 
		</td>
	</tr>
