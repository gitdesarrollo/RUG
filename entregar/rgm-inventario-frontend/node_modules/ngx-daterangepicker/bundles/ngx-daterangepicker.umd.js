...
var NgxDateRangePickerComponent = /** @class */ (function () {
    ...
    NgxDateRangePickerComponent.prototype.selectDate = function (e, index) {
        ...
        if ((this.opened === 'to' && __WEBPACK_IMPORTED_MODULE_2_date_fns__["isBefore"](selectedDate, this.dateFrom))) {
            this.opened = 'from';
        }
    ...
    NgxDateRangePickerComponent.prototype.selectRange = function (range) {
        ...
        switch (unit) {
            case 'm':
                if (operand < 0) {
                    today = __WEBPACK_IMPORTED_MODULE_2_date_fns__["subMonths"](today, amount * operand);
                }
                else {
                    today = __WEBPACK_IMPORTED_MODULE_2_date_fns__["addMonths"](today, amount * operand);
                }
            ...
            case 'w':
                if (operand < 0) {
                    today = __WEBPACK_IMPORTED_MODULE_2_date_fns__["subWeeks"](today, amount * operand);
                }
                else {
                    today = __WEBPACK_IMPORTED_MODULE_2_date_fns__["addWeeks"](today, amount * operand);
                }
            ...
            case 'y':
                if (operand < 0) {
                    today = __WEBPACK_IMPORTED_MODULE_2_date_fns__["subYears"](today, amount * operand);
                }
                else {
                    today = __WEBPACK_IMPORTED_MODULE_2_date_fns__["addYears"](today, amount * operand);
                }
            ...
            default:
                if (operand < 0) {
                    today = __WEBPACK_IMPORTED_MODULE_2_date_fns__["subDays"](today, amount * operand);
                }
                else {
                    today = __WEBPACK_IMPORTED_MODULE_2_date_fns__["addDays"](today, amount * operand);
                }
                this.dateFrom = __WEBPACK_IMPORTED_MODULE_2_date_fns__["startOfDay"](today);
                this.dateTo = __WEBPACK_IMPORTED_MODULE_2_date_fns__["endOfDay"](today);
                break;
        }
        this.date = __WEBPACK_IMPORTED_MODULE_2_date_fns__["startOfDay"](this.dateFrom);
