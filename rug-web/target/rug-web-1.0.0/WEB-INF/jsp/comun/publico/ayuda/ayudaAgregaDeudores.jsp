...
<table cellspacing="0" cellpadding="0" width="90%" height="90%"
	...
	<tr>
		<td class="tituloInteriorRojo">
			<br class="tituloInteriorRojo"><s:text name="Agregar Deudor" /><br />
	...
	<tr>
		<td>			
			<br class="texto_general"> 
				<s:text name="<b>II.-</b> El Otorgante y, en su caso, el o los deudores;" /><br />
	...
	<tr>
		<td>		
			<br class="texto_general">
				<s:text name="<b>III.  </b> El Otorgante y, en su caso, el o los deudores;" /><br />
		</td>	
	</tr>
	<tr>
		<td>			 
