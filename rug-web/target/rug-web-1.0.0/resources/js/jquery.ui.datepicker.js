...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		dayNamesShort: ['D', 'L', 'Ma', 'Mi', 'J', 'V', 'S'], // For formatting
		dayNamesMin: ['D', 'L', 'Ma', 'Mi', 'J', 'V', 'S'], // Column headings for days starting at Sunday
	...
	this.dpDiv = $('<div id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all ui-helper-hidden-accessible" style="margin-left: 150px margin-top:21px; background-color: #E0ECF8;"></div>');
}
...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			'<a style="cursor:pointer;" class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_' + dpuuid +
		...
		var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			'<a style="cursor:pointer;" class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_' + dpuuid +
			'.datepicker._adjustDate(\'#' + inst.id + '\', +' + stepMonths + ', \'M\');"' +
