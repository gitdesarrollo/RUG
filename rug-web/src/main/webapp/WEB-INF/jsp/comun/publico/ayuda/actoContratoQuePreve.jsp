...
<table cellspacing="0" cellpadding="0" width="90%" height="90%"
	...
	<tr>
		<td align="justify">		
			<br class="texto_general">
				<s:text	name="<b>Art.33 Bis.-</b> Las operaciones que se pueden realizar en el RUG son las siguientes:" /> 
			<br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td align="justify">		
			<br class="texto_general">
				<s:text	name="III. Modificación, transmisión, rectificación por error y cancelación de garantías mobiliarias, así como renovación de inscripción." /> 
			<br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td>		
			<br class="texto_general">
				<s:text	name=" b)	Materia Prima sujeta a los procesos de fabricación.  " /> 
		</td>
	</tr>
</table>
