...
<table cellspacing="0" cellpadding="0" width="90%" height="90%"
	...
	<tr>
		<td class="tituloInteriorRojo">
			<br class="tituloInteriorRojo"><s:text name="Persona que solicita o Autoridad que instruye la Inscripción y contenido de la Resolución : " /><br />
